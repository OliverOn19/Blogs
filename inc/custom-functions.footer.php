...
/**
Function name:              tonsberg_footer_row1()
Function description:       Footer row 1
*/
function tonsberg_footer_row1(){
    ...
    echo '<div class="row">';
        echo '<div class="col-md-12 footer-row-1">';
            ...
            if (class_exists( 'ReduxFrameworkPlugin' ) ) {
                $footer_row_1_layout = $tonsberg_redux['mt_footer_row_1_layout'];
                $nr = array("1", "2", "3", "4", "6");
...
/**
Function name:              tonsberg_footer_row2()
Function description:       Footer row 2
*/
function tonsberg_footer_row2(){
    ...
    echo '<div class="row">';
        echo '<div class="col-md-12 footer-row-2">';
            ...
            if (class_exists( 'ReduxFrameworkPlugin' ) ) {
                $footer_row_2_layout = $tonsberg_redux['mt_footer_row_2_layout'];
                $nr = array("1", "2", "3", "4", "6");
...
/**
Function name:              tonsberg_footer_row3()
Function description:       Footer row 3
*/
function tonsberg_footer_row3(){
    ...
    echo '<div class="row">';
        echo '<div class="col-md-12 footer-row-3">';
            ...
            if (class_exists( 'ReduxFrameworkPlugin' ) ) {
                $footer_row_3_layout = $tonsberg_redux['mt_footer_row_3_layout'];
                $nr = array("1", "2", "3", "4", "6");
