...
// THUMBNAIL
$post_img = '';
$thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'tonsberg_about_625x415' );
if ($thumbnail_src) {
        ...
        <div class="<?php echo esc_attr($post_col); ?> post-details">
            <div class="post-details-padding">
                ...
                <div class="post-category-comment-date row">
                    <!-- POST META: DATE -->
                    <div class="post-date">
                        <a title="<?php the_title_attribute() ?>" href="<?php echo esc_url(get_the_permalink()); ?>"><i class="icon-calendar"></i><?php echo esc_html(get_the_date()); ?></a>
                    </div>
                    <!-- POST META: TAGS -->
                ...
                <?php
                    ...
                    the_content( sprintf(__( 'Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i>', 'tonsberg' ),
